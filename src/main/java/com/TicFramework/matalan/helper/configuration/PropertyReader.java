...
public class PropertyReader implements ConfigReader {
	...
	public PropertyReader() {
		try {
			String filePath = ResourceHelper.getResourcePath("src/main/resources/configfiles/config_test.properties");
			file = new FileInputStream(new File(filePath));
			OR = new Properties();
			OR.load(file);
			
			/*String filePath1 = ResourceHelper.getResourcePath("src/main/resources/configfiles/config_dev.properties");
